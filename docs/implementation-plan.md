...
1. 建立公開 GitHub repository，推送原始碼並確認 `updates/update.json` 可由 HTTPS 讀取。
2. 建立未簽章 0.1.0 公開測試版及 SHA-256，Release 說明必須揭露 Windows 可能警告或封鎖。
3. 在沒有 Python 的乾淨 Windows 10／11 x64 環境測試離線安裝、雙擊啟動、合併、更新入口、結束及解除安裝。
