...
| 自動化測試 | 已完成 | 目前共 74 項全數通過，涵蓋合併、PDF 轉圖片、介面、啟動器、更新、打包與升級驗證腳本 |
...
| Inno Setup 安裝程式 | 已完成 | 安裝程式與 SHA-256 採版本化檔名；0.2.0 已完成 per-user 離線安裝、捷徑、操作、解除安裝與發布驗收 |
...
`0.2.0` 已完成發布。公開更新資訊指向可下載的 0.2.0，0.1.0 使用者可由啟動器前往 GitHub Releases 手動下載並直接覆蓋安裝。
