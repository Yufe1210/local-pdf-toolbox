...
| PyInstaller onedir | 已完成 | Python 3.13.14 建置成功並核對 15 個必要模組、自訂拖曳網格前端、PDFium DLL 及授權檔；完整建置通過 `--self-test`、loopback smoke test 與外部 Windows 安裝驗收 |
...
| PDF 轉圖片 | 進行中 | 0.2.0；多 PDF、PNG／JPEG、兩種 ZIP 結構及已確認命名規則 |
...
4. **進行中**：開發 PDF 轉圖片，完成後以 0.2.0 驗證更新提示、GitHub 下載及手動覆蓋安裝流程。
