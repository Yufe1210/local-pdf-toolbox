...
> 更新日期：2026-07-24
>
> 目前狀態：`0.2.0` 已發布；`0.2.1` 空密碼 PDF 相容性修正已完成候選建置與外部 Windows 驗收，可準備發布。
...
`0.2.0` 已完成發布。`0.2.1` 空密碼 PDF 判定修正、完整測試、未簽章候選打包及外部 Windows 驗收均已完成；下一步為合併至 `main` 並準備 GitHub Release。公開更新資訊仍維持可下載的 0.2.0，待 0.2.1 正式發布後才切換。
...
8. **待發布**：將已驗收修正合併至 `main`，建立 `v0.2.1` GitHub Release 並確認資產可下載後，才將公開 feed 切換至 0.2.1。
