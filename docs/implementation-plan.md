...
> 更新日期：2026-07-19
>
> 目前狀態：`0.1.0` 未簽章公開測試版已發布；下一個功能目標為 `0.2.0` 拆分 PDF。
...
`0.1.0` 已完成發布。後續先維持既有更新資訊可用，再開發拆分 PDF，並以 `0.2.0` 實際驗證跨版本更新提示與手動覆蓋安裝。
...
4. 接著開發拆分 PDF，並以 0.2.0 驗證更新提示、GitHub 下載及手動覆蓋安裝流程。
