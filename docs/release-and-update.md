...
- 發布日期：2026-07-20。
- tag：`v0.2.0`，指向 commit `f8313fb67a9f3485884ec4ebd3352b234e93b31a`。
- Release：<https://github.com/Yufe1210/local-pdf-toolbox/releases/tag/v0.2.0>。
- 安裝程式：`LocalPDFToolbox-Setup-v0.2.0.exe`，65,764,188 bytes。
- SHA-256：`a66e1296297034a75a1271f247bf0bc5468ace396bb970d460e67de2877e8acb`。
- 狀態：一般 GitHub Release、`latest`、非 draft、非 Pre-release；標題與說明明確標示未簽章公開測試版。
