...
> 更新日期：2026-07-19
>
> 目前狀態：`0.1.0` 未簽章公開測試版已發布；`0.2.0` PDF 轉圖片功能開發中。
...
| 自動化測試 | 已完成 | 72 項測試通過，涵蓋合併、PDF 轉圖片、命名、兩種 ZIP 結構、PNG／JPEG、DPI、錯誤、介面、預覽資源、啟動器、更新與打包；封裝清單與所有自家 Python 模組一致 |
...
| PDF 轉圖片 | 已實作，待外部驗收 | 多 PDF、PNG／JPEG、兩種 ZIP 結構、命名、瀏覽器、代表性渲染與 0.2.0 候選打包均已驗證 |
...
4. **已完成本機部分**：PDF 轉圖片功能、瀏覽器、代表性渲染及 0.2.0 候選打包已通過；待外部無 Python Windows 驗收與 0.1.0 → 0.2.0 更新流程。
